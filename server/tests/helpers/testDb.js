...
export const seedTestData = (db) => {
  db.prepare('INSERT INTO categories (id, name, kind, color, icon) VALUES (?, ?, ?, ?, ?)').run('cat-1', 'Comida', 'gasto', '#ff0000', 'icon');
  db.prepare('INSERT INTO accounts (id, name, type, initial_balance) VALUES (?, ?, ?, ?)').run('acc-1', 'Efectivo', 'efectivo', 1000);
